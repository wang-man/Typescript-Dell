...
var Imooc = /** @class */ (function () {
    ...
    // 1.拿到爬虫得到的原始html
    Imooc.prototype.getImoocHtml = function (crawler) {
    ...
    Imooc.prototype.parseHtml = function (html) {
        var $ = cheerio_1.default.load(html);
        var courseDomList = $('.container-types');
        var curseData = [];
    ...
    // 3.生成所需数据格式，给到爬虫
    Imooc.prototype.generateContent = function (courseData) {
        ...
        var newContent = Object.assign({}, fileContent, oneImoocJson);
